...
$('#mytab').bootstrapTable({
    ...
    url: "/keyIn/hotelKeyInList",//要请求数据的文件路径
...
function refush() {
    $('#mytab').bootstrapTable('refresh', {url: '/keyIn/hotelKeyInList'});
}
$("#update").click(function () {
    $.post(
        "/keyIn/keyInUpdateSave",
