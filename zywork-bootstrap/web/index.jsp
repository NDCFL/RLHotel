...
<head>
    ...
    <link rel="stylesheet" href="<%=path %>/static/css/fonts/font-awesome.css" />
...
<form class="form-horizontal" role="form" id="form" action="<%=path%>/manager/managerregister">
...
<script type="text/javascript" src="<%=path %>/static/js/jquery.min.js"></script><!-- jQuery -->
<script type="text/javascript" src="<%=path%>/static/js/bootstrap.min.js"></script><!-- Bootstrap -->
...
<%--<script type="text/javascript">--%>
    <%--function findmypwd(name){--%>
        ...
        <%--}--%>
        <%--$.post(--%>
            <%--"${pageContext.request.contextPath}/manager/findpwd",--%>
            <%--{--%>
                <%--"useraccount":name--%>
            <%--},--%>
            <%--function(data){--%>
