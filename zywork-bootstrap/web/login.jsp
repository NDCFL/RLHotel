    ...
    <div>
        ...
        <form class="m-t" role="form" id="form" action="index.html">
            <div class="form-group">
                <input type="email" class="form-control" name="userAccount" placeholder="登录账号" required="">
            </div>
            <div class="form-group">
                <input type="password" class="form-control" name="userPassword" placeholder="登录密码" required="">
            </div>
