            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    ...
                    <div class="col-sm-1" style="width: 120px" >
                        <select class="form-control"  id="hotelId_" style="width: 130px;margin-left: -20px" onchange="getCardTitle(this.value);" required name="hotelId">

                        </select>
                    </div>
                    <label class="col-sm-1 control-label" style="width:100px;line-height: 30px;margin-left: -10px">房型名称</label>
                    <div class="col-sm-1" style="width: 120px" >
                        <select class="form-control"  id="houseType_" style="width: 130px;margin-left: -20px" required name="type">

                        </select>
                    </div>
                    <label class="col-sm-1 control-label" style="width:100px;line-height: 30px;margin-left: -10px">房型状态</label>
                    <div class="col-sm-1" style="width: 120px" >
                        <select class="form-control"  id="isActive" style="width: 130px;margin-left: -20px" required name="isActive">
                            <option value="0">启用</option>
                            <option value="1">停用</option>
                        </select>
                    </div>
                    <label class="col-sm-1 control-label" style="width:100px;line-height: 30px;margin-left: -10px">房型类别</label>
                    <div class="col-sm-1" style="width: 120px" >
                        <select class="form-control"  id="house__Type" style="width: 130px;margin-left: -20px" required name="houseType">
